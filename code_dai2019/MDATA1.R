...
temp2=runif(1,0,0.9)
temp3=runif(1,0,0.9)
data[i,,]=cbind(a[,1]*((x<=temp3)+(x>=(temp3+0.1))+sign(temp3-0.45)*5*(x>temp3)*(x<(temp3+0.1))),a[,2]*((x<=temp2)+(x>=(temp2+0.1))+sign(temp2-0.45)*5*(x>temp2)*(x<(temp2+0.1))))
}
}
return(data)
}